...
type
  ...
  TCore = record
    ...
    procedure SetConfig(Value: TCoreOptions);
...
const
  CoreConsoles: array[0..73] of TCoreConsole =
    ((Core: 'Stock'; Console: 'Nintendo - Nintendo Entertainment System (Famicom) [FCEUmm]'; NoIntro:  45; Extensions: 'nes|unf'; BIOSChecker: TBIOSCheckerNone),
     ...
     (Core: 'Stock'; Console: 'Nintendo - Nintendo Entertainment System (Famicom) [unknown emulator]'; NoIntro:  45; Extensions: 'nfc'; BIOSChecker: TBIOSCheckerNone),
     ...
     (Core: 'Stock'; Console: 'Nintendo - Game Boy [TGB Dual v0.8.3]'; NoIntro:  46; Extensions: 'gba|agb|zgb'; BIOSChecker: TBIOSCheckerNone),
     ...
     (Core: 'Stock'; Console: 'Compressed and/or thumbnailed file'; NoIntro:  0; Extensions: 'bkp|zip|zfc|zsf|zpc|zmd|zgb|zfb'; BIOSChecker: TBIOSCheckerNone),
     ...
     (Core: 'a78';   Console: 'Atari - 7800'; NoIntro:   1; Extensions: 'a78|bin'; BIOSChecker: TBIOSCheckerNone),
     ...
     (Core: 'gb';   Console: 'Game Boy'; NoIntro:  46; Extensions: 'gb|sgb'; BIOSChecker: TBIOSCheckerNone),
     (Core: 'gb';   Console: 'Game Boy Color'; NoIntro:  47; Extensions: 'gbc|sgb'; BIOSChecker: TBIOSCheckerNone),
     (Core: 'gba';   Console: 'Game Boy Advance'; NoIntro:  23; Extensions: 'gba|bin'; BIOSChecker: TBIOSCheckerGameBoyAdvance),
     (Core: 'gbav';   Console: 'Game Boy Advance'; NoIntro:  23; Extensions: 'gba'; BIOSChecker: TBIOSCheckerGameBoyAdvance),
     (Core: 'gbb';   Console: 'Game Boy'; NoIntro:  46; Extensions: 'gb|dmg'; BIOSChecker: TBIOSCheckerGameBoyGambatte),
     (Core: 'gbb';   Console: 'Game Boy Color'; NoIntro:  47; Extensions: 'gbc|dmg'; BIOSChecker: TBIOSCheckerGameBoyColorGambatte),
     (Core: 'gbgb';   Console: 'Game Boy'; NoIntro:  46; Extensions: 'gb|dmg|sgb'; BIOSChecker: TBIOSCheckerGameBoy),
     (Core: 'gbgb';   Console: 'Game Boy Color'; NoIntro:  47; Extensions: 'dmg|gbc|sgb'; BIOSChecker: TBIOSCheckerGameBoyColor),
     ...
     //(Core: 'o2em';   Console: 'Magnavox - Odyssey2'; NoIntro:  9; Extensions: 'bin'; BIOSChecker: TBIOSCheckerMagnavoxOdyssey2), // this thing is waaay too confusing
     //(Core: 'o2em';   Console: 'Philips - Videopac+'; NoIntro:  16; Extensions: 'bin'; BIOSChecker: TBIOSCheckerVideopacPlus),
     ...
     //(Core: 'pcfx';   Console: 'NEC - PC-FX'; NoIntro:  -; Extensions: 'cue|ccd|toc|chd'; BIOSChecker: TBIOSCheckerPCFX),
  ...
  Cores: array[0..92] of TCore =
    ((Core: 'multicore'; Name: 'multicore General Options (configuration only)'; Config: 'multicore'),
     (Core: 'Stock'; Name: 'GB300 Stock Emulators'; Config: ''; Description: 'NES, PCE, SNES, MD, SMS, GB, GBC, GBA'),
     ...
     (Core: 'gb'; Name: 'TGB Dual'; Config: 'TGB Dual'; Description: 'Game Boy Classic, Color'),
     ...
     (Core: 'zx81'; Name: 'EightyOne'; Config: ''; Description: 'Sinclair ZX 81'),
     ...
     (Core: 'c64fc'; Name: 'FrodoSC'; Config: ''; Description: 'Commodore 64'),
     (Core: 'glxy'; Name: 'Galaxy'; Config: ''; Description: 'Galaksija'),
     (Core: 'gbb'; Name: 'Gambatte'; Config: ''; Description: 'Game Boy Classic, Color'),
     ...
     (Core: 'xmil'; Name: 'X Millennium'; Config: ''; Description: 'Shape X1'));
...
function TCore.GetConfig: TCoreOptions;
var
  i: Integer;
  OptFile: TStringList;
  Row: string;
...
begin
  ...
  try
    OptFile.LoadFromFile(IncludeTrailingPathDelimiter(IncludeTrailingPathDelimiter(Path + 'cores') + 'config') + Config + '.opt');
...
procedure TCore.SetConfig(Value: TCoreOptions);
var
  sl: TStringList;
  Option: TCoreOption;
begin
  ...
  try
    ...
    sl.SaveToFile(IncludeTrailingPathDelimiter(IncludeTrailingPathDelimiter(Path + 'cores') + 'config') + Config + '.opt');
  finally
    sl.Free();
  end;
end;
...
begin
  ...
  begin
    SetLength(Result, 1);
    Result[0] := CheckBIOSFile('gb_bios.bin', False, [$81977335]);
  end;
end;
...
begin
  ...
  begin
    SetLength(Result, 2);
    Result[0] := CheckBIOSFileAbs(IncludeTrailingPathDelimiter(IncludeTrailingPathDelimiter(IncludeTrailingPathDelimiter(IncludeTrailingPathDelimiter(Path + 'GBA') + 'mnt') + 'sda1') + 'bios') +'gb_bios.bin', False, [$81977335]);
    Result[1] := CheckBIOSFileAbs(IncludeTrailingPathDelimiter(IncludeTrailingPathDelimiter(IncludeTrailingPathDelimiter(Foldername.AbsoluteFolder[7] + 'mnt') + 'sda1') + 'bios') +'gb_bios.bin', False, [$81977335]);
  end;
end;
...
begin
  ...
  Result[2] := CheckBIOSFile('Machines\COL - Bit Corporation Dina\czz50-1.rom', True, [$6538DD32]);
